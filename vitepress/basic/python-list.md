...
Based on PEP [3132](https://www.python.org/dev/peps/pep-3132), we can use a single asterisk to unpack N elements to the number of variables which is less than N in Python 3.
