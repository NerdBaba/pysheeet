...
If you're interested in future statements and want to acquire more explanation, further information can be found on [PEP 236 - Back to the \_\_future\_\_](https://www.python.org/dev/peps/pep-0236)
...
After version 3.7, Python introduces the future statement, `annotations`, to perform postponed evaluation. It will become the default feature in Python 4. For further information please refer to PEP [563](https://www.python.org/dev/peps/pep-0563).
